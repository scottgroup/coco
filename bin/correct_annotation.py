...
parser.add_argument("-o", "--output", help="Name of output gtf. Default: add 'correct_annotation' suffix to original gtf name.", default='None')
...
gapped_gtf.correct_annotation(gtf_file,output)
